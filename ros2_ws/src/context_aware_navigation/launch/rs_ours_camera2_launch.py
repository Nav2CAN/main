...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera2', 'description': 'right_camera'},
                           ...
                           {'name': 'rgb_camera.profile',
                               'default': '0,0,0', 'description': 'color image width'},
